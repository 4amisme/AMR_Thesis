...
write.csv(df_final_results, "2_aba_Forecast_5Years_All_Patterns_LogitGaussian.csv", row.names = FALSE)

cat("ไฟล์ '2_aba_Forecast_5Years_All_Patterns_LogitGaussian.csv' \n")
